...
# SQLAlchemy-migrate creates a migration is by comparing the structure
# of the database (obtained in our case from file app.db) against the
...
# To make it easy for SQLAlchemy-migrate to determine the changes I never
# rename existing fields, I limit my changes to adding or removing models
# or fields, or changing types of existing fields. And I always review
# the generated migration script to make sure it is right.
